...
const Header = ({ handleThemeSwitch, theme }) => {
    ...
    const deleteNotify = () => {
        axios
            .delete(`${process.env.REACT_APP_API_URI}/notifications/delete-all-notify`, {
                withCredentials: true,
                headers: {
                    Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
                },
    ...
    return (
        <div>
            <nav
                className={`flex-no-wrap relative flex w-full items-center   justify-between lg:flex-wrap lg:justify-start  lg:py-4 ${isScrolled
                ...
                <div className="flex w-full flex-wrap items-center justify-between px-3 ">
                    ...
                    >
                        ...
                        >
                            {theme === 'dark' ? (
                                ...
                                <img src={logoWhite} alt="logo" className="object-cover max-h-20" loading="lazy" />
                            )}
                        </a>
                        <ul className="list-style-none mr-auto flex flex-col pl-0 lg:flex-row " data-te-navbar-nav-ref>
                            {headerMenu.slice(0, headerMenuLength).map((item, index) => (
                                <li
                                    className="mb-4 lg:mb-0 lg:pr-2 dark:text-main-300 "
                    ...
                    <div className="relative flex items-center">
                        <div className="flex items-center gap-4 text-white ">
                            {!isSearchOpen && <div className="flex ">
                            ...
                            <Search isDark={theme === 'dark'} isScroll={isScrolled} isSearchOpen={isSearchOpen} toggleSearch={toggleSearch} />
                            {!isSearchOpen && <div className="cursor-pointer">
                                {notify.length > 0 && (
                ...
                <div key={index} className="flex items-center my-4">
                    ...
                    <div className="w-2/5">
                        ...
                        <p className="text-gray-500">
                            {t('Likes_comment')} {x.likes.length}
                        </p>
                        <p className="text-gray-500">
                            {t('Comment')} {x.content}
                        </p>
