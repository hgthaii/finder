    ...
    return (
        <div className="flex justify-between">
            ...
            <div className="flex justify-end w-11/12 mr-8">
                <div className="w-full  rounded-lg  flex justify-between  bg-main-200 text-white dark:bg-main-100 dark:text-main-300">
                    <form className="flex justify-between items-center w-full">
                        ...
                        <div className="border-b border-[#BCBCBC] w-4/5 ">
                            <textarea
                                ...
                                className=" outline-none w-full  bg-main-200 text-white dark:bg-main-100 dark:text-main-300"
                            ></textarea>
                        </div>
