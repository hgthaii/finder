...
export const getGenres = (idGenre) => async (dispatch) => {
    try {
        ...
        if (response.status === 200) {
            dispatch({
                type: actionType.GENRES, data: response.data
            })
        } else {
            dispatch({
                type: actionType.GENRES, data: null
            })
        }
...
export const getDetailtMovies = (mid) => async (dispatch) => {
    try {
        ...
        if (response.status === 200) {
            dispatch({
                type: actionType.DETAI_MOVIES, data: response.data
            })
        } else {
            dispatch({
                type: actionType.DETAI_MOVIES, data: null
            })
        }
