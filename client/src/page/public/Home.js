    ...
    return (
        <div className="">
            ...
            <div className="relative top-[-10.3125rem] z-[6] bottom-0 left-0 mt-[100px] lg:mt-0">
                <div className="my-4">
                    <h3 className="text-white mb-2 px-[48px] text-[18px] font-bold dark:text-black">Mới phát hành</h3>
                    <Swiper {...swiperParams}>
                ...
                <div className="my-4">
                    <h3 className="text-white mb-4 px-[48px] text-[18px] font-bold dark:text-black">Đang thịnh hành</h3>
                    <Swiper {...swiperParams}>
