...
const Help = () => {
    return (
        <div>
            <footer
                className="bg-main-200 dark:bg-main-100  dark:text-main-300 text-white mt-[100px] h-full  text-center   lg:text-left">
                ...
                <div className="mx-6 py-10 text-center md:text-left">
                    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div className="">
                            ...
                            <p className="mb-4 hover:underline decoration-red-400">
                                <a href="#!"
                                >How to download titles to watch offline</a
                                >
                            </p>
