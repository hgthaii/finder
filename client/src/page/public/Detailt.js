    ...
    return (
        <div className='bg-main-200 dark:bg-main-100  dark:text-main-300 text-white mt-[100px] h-full px-10'>
            ...
            <section id="example-2">
                ...
                <p className='mt-3'>
                    Chúng tôi có thể cung cấp một số gói thành viên, bao gồm cả tư cách thành viên được các bên thứ ba cung cấp đi kèm với các sản phẩm và dịch vụ của riêng họ. Chúng tôi không chịu trách nhiệm đối với các sản phẩm và dịch vụ được cung cấp bởi các bên thứ ba đó. Một số gói thành viên có thể có các điều kiện và giới hạn khác nhau mà sẽ được đưa ra khi bạn đăng ký hoặc trong các thông tin liên lạc khác được cung cấp cho bạn. Bạn có thể tìm thấy thông tin chi tiết cụ thể về tư cách thành viên Finder của mình bằng cách truy cập trang web Finder.com và nhấp vào liên kết “Tài khoản” ở đầu các trang dưới tên hồ sơ của mình.
                </p>
            </section>
            ...
            <section id="example-4">
                ...
                <p className='mt-3'>
                    Dịch vụ Finder và bất kỳ nội dung nào được truy cập qua dịch vụ này chỉ dành cho mục đích sử dụng cá nhân, phi thương mại và không được chia sẻ với các cá nhân ngoài hộ gia đình bạn, trừ trường hợp gói đăng ký của bạn cho phép. Trong thời gian bạn là thành viên Finder, chúng tôi cấp cho bạn quyền hạn chế, không độc quyền, không thể chuyển nhượng để truy cập dịch vụ Finder và nội dung trên Finder. Ngoại trừ những điều đã đề cập ở trên, bạn không có bất kỳ quyền, quyền sở hữu hay quyền lợi nào khác. Bạn đồng ý không sử dụng dịch vụ cho các mục đích biểu diễn tại nơi công cộng
                </p>
                <p className='mt-3'>
                    Dịch vụ Finder, bao gồm cả thư viện nội dung, được cập nhật thường xuyên. Ngoài ra, chúng tôi liên tục thử nghiệm các khía cạnh khác nhau của dịch vụ, bao gồm cả các trang web của chúng tôi, giao diện người dùng và tính năng quảng cáo. Bạn có thể tắt tùy chọn tham gia thử nghiệm bất cứ lúc nào bằng cách truy cập trang “Tài khoản” rồi thay đổi chế độ cài đặt “Tham gia thử nghiệm”
                </p>
                <p className='mt-3'>
                    Một số nội dung trên Finder có thể được tải xuống tạm thời và xem ngoại tuyến trên một số thiết bị được hỗ trợ nhất định (“Phim và chương trình ngoại tuyến”). Các giới hạn được áp dụng, bao gồm cả các hạn chế về số lượng Phim và chương trình ngoại tuyến trên mỗi tài khoản, số lượng thiết bị tối đa có thể chứa Phim và chương trình ngoại tuyến, khoảng thời gian bạn cần để bắt đầu xem Phim và chương trình ngoại tuyến, cũng như khoảng thời gian mà Phim và chương trình ngoại tuyến còn có thể truy cập được. Một số Phim và chương trình ngoại tuyến có thể không phát được ở một số quốc gia nhất định và nếu bạn truy cập trực tuyến ở một quốc gia nơi bạn không thể phát trực tuyến Phim và chương trình ngoại tuyến đó, bạn sẽ không thể phát Phim và chương trình ngoại tuyến khi bạn đang ở quốc gia đó
                </p>
                <p className='mt-3'>
                    Bạn đồng ý sử dụng dịch vụ Finder, bao gồm tất cả các tính năng và chức năng đi kèm, phù hợp với tất cả các luật, quy tắc và quy định hiện hành, hoặc các hạn chế khác đối với việc sử dụng dịch vụ hoặc nội dung chứa trong đó. Trừ trường hợp được chúng tôi cho phép rõ ràng, bạn đồng ý không:
                    (i) lưu trữ, sao chép, phân phối, sửa đổi, trình chiếu, biểu diễn, xuất bản, cấp phép, tạo các tác phẩm phái sinh, chào bán hoặc sử dụng các nội dung và thông tin có trong hoặc thu được từ hay thông qua dịch vụ Finder;
                </p>
